...
info = {'resume': True,                        #Allow to debug
       ...
       'params': {
        ...
        "sampler": {"polychord":
                        {"nlive": 125, "precision_criterion": 1e-3}
                    }
           }
        
#Path for output folder and name of the directory. First line: path for Altamira.

info["output"] = "/gpfs/users/martinezg/OutputCobaya/2NodesResults_IntentoDeNuevo"
#info["output"] = "/Users/guillermo/Desktop/ProbandoCosmoFLDOFGDG/Results"
...
#fixed_values = {'tau': tauJPAS, 'mnu': mnuJPAS, 'nnu': nmuJPAS,
               #'x1': 0.0,
                ...
                #'y2': np.log(PrimordialPowerLaw(AsJPAS,nsJPAS,KArray[-1])), 
                #'H0': H0JPAS, 'ombh2': OmegabJPASh2, 'omch2': OmegaCDMJPASh2}

                    
                              

#model.logposterior(fixed_values)      #Evaluate the logposterior with the fixed_values    
